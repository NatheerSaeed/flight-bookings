...
{
    public static Banks ToDto(this Bank model)
    {
        return new Banks
        {
    ...
    public static Bank ToModel(this BankUpdateInput updateDto, BanksWhereUniqueInput uniqueId)
    {
        var banks = new Bank { Id = uniqueId.Id, Name = updateDto.Name };
